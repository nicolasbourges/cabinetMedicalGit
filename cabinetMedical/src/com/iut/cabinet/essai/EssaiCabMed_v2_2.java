...
/**
 * Essai de la version 2.2 de l'application pour le cabinet médical
 * @author Nicolas BOURGES
*/
public class EssaiCabMed_v2_2 {
	public static void main (String[] args) throws CabinetMedicalException{
		//appel au constructeur
		new EssaiCabMed_v2_2();
}
	EssaiCabMed_v2_2() throws CabinetMedicalException{
		//les patients
		...
		Professionnel  personne4 = new Professionnel (4, "CHILDREN", "Rose", DateUtil.toDate("1970-02-16"), false, "0555434343", "0607656321", "rose.chlidren@lesmedecins.fr", null, null, "3124445555", "Pédiatre"); //new Adresse(null, "10", null, "avenue de la Gare", "87000", "Limoges", "France")
		...
		try{
			...
			PatientRegle.verifierNir("297112010102401");
			System.out.println("\n 168072B12345652 est-il valide: ");
			PatientRegle.verifierNir("168072012345652");
		}
